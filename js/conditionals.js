...
//     }
//     else {
//         return "I don't have a message for this color";
//     }
// }
...
let colorChoice = prompt("Input a color:");
...
let customerTotal = prompt("What is the total amount?")
alert("Your total before discount: " +customerTotal + "\nYour total amount with a lucky number of " + luckyNumber + " is: $" + calculateTotal(customerTotal, luckyNumber));
/**
 * TODO:
...
function analyzeNumber() {
    ...
    if (answer === true) {
        ...
        if (isNaN(parseInt(input))) {
            ...
            let positiveNegative = number < 0 ? "negative" : "positive";

            alert(number + " is " + evenOdd + ".");
            alert(number + " + 100 is " + plus100 + ".");
            alert(number + " is " + positiveNegative + ".");
        }
    } else {
