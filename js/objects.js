(function () {
    ...
    shoppers.forEach(function (shopper) {
        ...
        console.log(`${shopper.name} spent $${shopper.amount} with a discount of $${discount.toFixed(2)}. The total amount after the discount is $${amountAfterDiscount.toFixed(2)}`);
    })
